package co.edu.javeriana.tandemsquad.tandementerprise.Permissions;
...
public class PermissionsManager
{
    ...
    public static boolean askPermissionWithJustification(Activity context, int permissionCode, String explanation) {
        String permission = permissions.get(permissionCode);
        if(!PermissionsManager.checkSelfPermission(context, permissionCode)) {
    ...
    public static boolean askPermission(Activity context, int permissionCode) {
        String permission = permissions.get(permissionCode);
        if(!PermissionsManager.checkSelfPermission(context, permissionCode)) {
            ActivityCompat.requestPermissions(context, new String[]{permission}, permissionCode);
            return false;
